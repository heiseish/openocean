package mui.pages.login

import mui.login.Styles.styles
    ...
    Grid
      ...
      .className(classes("container"))(
        div(className := classes("logotypeContainer"))(
          ...
          Typography.className(classes("logotypeText")).variant(Style.h3)("Open Ocean")
        ),
            ...
            Tabs(activeTabId)
              ...
              .centered(true)(
                Tab
                  ...
                  .className(
                    classNames(
                      StringDictionary[js.Any]("root" -> classes("tab"))
                    )
                  ),
                Tab
                  .label("New User")
            ...
            activeTabId match {
              ...
              case 1 =>
                Fragment(
                  Typography
                    .variant(Style.h2)
                    .className(classes("subGreeting"))("Sign Up"),
                  Fade.in(error)(
                    Typography
                      .color(secondary)
                      .className(classes("errorMessage"))(
