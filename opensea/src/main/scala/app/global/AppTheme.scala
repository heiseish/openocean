...
import typings.materialUiCore.createPaletteMod.{
  ColorPartial,
  PaletteColorOptions,
  PaletteOptions
}
    ...
    ThemeOptions()
      ...
      .setPalette(
        PaletteOptions()
          ...
          .setSecondary(
            PaletteColorOptions
              .SimplePaletteColorOptions(darken(pink.A400, 0.08))
  ...
  val component: FunctionalComponent[Props] = FunctionalComponent[Props] {
    props =>
      ...
      MuiThemeProvider(theme)(
        ...
        //         classes("credit") -> true,
        //         classes("hideCredit") -> props.hideCredit
        //       )
        //     )
        //   )(
        //     "Built with ",
        ...
        //     Link
        //       .color(Color.inherit)
        //       .href("www.scalablytyped.org")("ScalablyTyped Material-UI"),
        //     " team."
        //   )
      )
  }
